...
def main():
    ...
    np.savetxt('..//..//data//onefeature//onefeature_200_200_X_begin.csv', X_begin, delimiter = ',')
    np.savetxt('..//..//data//onefeature//onefeature_200_200_Y_begin.csv', Y_begin, delimiter=',')
    np.savetxt('..//..//data//onefeature//onefeature_200_200_X_normal.csv', X_normal, delimiter=',')
    np.savetxt('..//..//data//onefeature//onefeature_200_200_Y_normal.csv', Y_normal, delimiter=',')
    np.savetxt('..//..//data//onefeature//onefeature_200_200_X_adv.csv', advmalware, delimiter=',')
    np.savetxt('..//..//data//onefeature//onefeature_200_200_Y_adv.csv', Y_adv, delimiter=',')
