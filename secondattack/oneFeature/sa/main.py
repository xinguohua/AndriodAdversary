from secondattack.oneFeature.sa import utilities as ut
from secondattack.oneFeature.sa  import KnapSack as KS
import numpy as np
from secondattack.oneFeature.sa import Algorithms
import os
#origin
class Main(object):
