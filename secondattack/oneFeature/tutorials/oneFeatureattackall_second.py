...
def main():
    ...
    for i in range(5):
        if val_labels[i] == 1:
            ...
            del adversary
            print("second onefeature target attack done==========+"+str(i)+"个样本完成")
        else:
            # 添加良性软件
            y = val_data[i:i + 1][0]
            X_begin.append(y)
    ...
    np.savetxt('..//..//..//data//onefeature//second//onefeature_200_200_X_begin.csv', X_begin, delimiter = ',')
    np.savetxt('..//..//..//data//onefeature//second//onefeature_200_200_Y_begin.csv', Y_begin, delimiter=',')
    np.savetxt('..//..//..//data//onefeature//second//onefeature_200_200_X_normal.csv', X_normal, delimiter=',')
    np.savetxt('..//..//..//data//onefeature//second//onefeature_200_200_Y_normal.csv', Y_normal, delimiter=',')
    np.savetxt('..//..//..//data//onefeature//second//onefeature_200_200_X_adv.csv', advmalware, delimiter=',')
    np.savetxt('..//..//..//data//onefeature//second//onefeature_200_200_Y_adv.csv', Y_adv, delimiter=',')
