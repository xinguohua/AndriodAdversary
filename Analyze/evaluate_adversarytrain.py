...
#加载测试模型
#加载一种对抗训练模型 在不同攻击样本上测试
# trained_model = tf.keras.models.load_model('..//defence//adversarytrain//adversarial_jsmf_model.h5')
trained_model = tf.keras.models.load_model('..//defence//adversarytrain//adversarial_fgsm_model.h5')
