...
# MareWareTestset_from_csv =MareWareDataset('.//datajsma//X_adv.csv','.//datajsma//Y_adv.csv',transformations)
MareWareTestset_from_csv =MareWareDataset('.//datajsma//X_normal.csv','.//datajsma//Y_normal.csv',transformations)
...
# aleatoric.to_csv(".//featuresjsma//x_adv_aleatoric.csv",encoding='gbk')
#
# epistemic=pd.DataFrame(data=epistemic,columns=["epistemic",])
# epistemic.to_csv(".//featuresjsma//x_adv_epistemic.csv",encoding='gbk')
# combine=pd.DataFrame(data=combine,columns=["combine",])
# combine.to_csv(".//featuresjsma//x_adv_combine.csv",encoding='gbk')


#=======存入normal================
aleatoric=pd.DataFrame(data=aleatoric,columns=["aleatoric",])#
aleatoric.to_csv(".//featuresjsma//x_normal_aleatoric.csv",encoding='gbk')

epistemic=pd.DataFrame(data=epistemic,columns=["epistemic",])
epistemic.to_csv(".//featuresjsma//x_normal_epistemic.csv",encoding='gbk')
combine=pd.DataFrame(data=combine,columns=["combine",])
combine.to_csv(".//featuresjsma//x_normal_combine.csv",encoding='gbk')
